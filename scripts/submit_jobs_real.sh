...
sbatch --cpus-per-task=1 --mail-user="A.M.Leeuwenberg-15@umcutrecht.nl" --error="./errors/slurm-%A_%a.out" --output="./out/slurm-%A_%a.out" --mail-type=END,FAIL --time=12:00:00 --array=0-99:1  1_job_real.sh
